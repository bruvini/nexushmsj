...
import { saveActivityLog, toggleClinicalTag, updateProvavelAlta, removeProvavelAlta, updateFluxoTrauma, removeFluxoTrauma, updateMedications, updatePatientSpecialties } from '../services/kanbanService';
...
export default function PainelKanban() {
  ...
  const salvarSisreg = async () => {
    ...
    try {
      ...
      await saveActivityLog(modalSisregPaciente.id, 'SISREG', `Inseriu/Atualizou número MV: ${formSisreg.numero.trim().toUpperCase()}`);
