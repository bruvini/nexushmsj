...
export default function Configuracoes() {
  ...
  const salvarEspecialidade = async (e) => {
    ...
    } catch (error) { toast.error("Erro ao salvar especialidade.") }
  ...
  const confirmarDeletarEspecialidade = async () => {
    ...
    } catch (error) { toast.error("Erro ao excluir especialidade.") }
    finally { 
  ...
  const salvarMedico = async (e) => {
    ...
    } catch (error) { toast.error("Erro ao salvar médico.") }
    finally { setLoading(false) }
  }
  ...
  const confirmarDeletarMedico = async () => {
    ...
    } catch (error) { toast.error("Erro ao excluir médico.") }
    finally { 
  ...
  const salvarProcedimento = async (e) => {
    ...
    } catch (error) { toast.error("Erro ao salvar procedimento.") }
    finally { setLoading(false) }
  }
  ...
  const confirmarDeletarProcedimento = async () => {
    ...
    } catch (error) { toast.error("Erro ao excluir procedimento.") }
    finally { 
